...
- **Before proposing any fix via xppai-codefix:** collect code tag fields (Tag ID, Project ID, Dev name, Date DD/MM/YYYY), state exact object location (Class/Table/Form + Method + Layer), and flag any signature changes.
